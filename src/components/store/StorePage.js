...
const StorePage = () => {
    return (
        ...
        <Paragraph>A <a href="https://docs.google.com/forms/d/e/1FAIpQLSfvr8pE9Se3DCHQskVRMHorqGt8t0HWRa1hPAfnTpqqnBpJIQ/viewform" target="_blank" rel="noopener noreferrer">membership form</a> must be sent in to activate new memberships.</Paragraph>
