...
const StorePage = () => {
    return (
        ...
        <Paragraph>A <a href="https://docs.google.com/forms/d/e/1FAIpQLScvEaYRLGqH_ifoA5oJnMBg2KotOu4H9WAyaeZBmEIxFJzhww/viewform" target="_blank" rel="noopener noreferrer">membership form</a> must be sent in to activate new memberships.</Paragraph>
