...
<List>
     ...
     <ListItem>- Honeybees will usually travel approximately 3 miles from their hive. - Honeybees are the only bees that die after they sting. </ListItem>
     ...
     <ListItem>- Bees communicate with each other by dancing and by using pheromones (scents). Honeybees never sleep!</ListItem>
      </List>
      ...
      <ListItem> - Flowers and other blossoming plants have nectarines that produce sugary nectar. </ListItem>
      <ListItem> - Worker bees suck up the nectar and water and store it in a special honey stomach. When the stomach is full the bee returns to the hive and puts the nectar in an empty honeycomb. </ListItem>
      <ListItem> - Natural chemicals from the bee's head glands and the evaporation of the water from the nectar change the nectar into honey. </ListItem>
