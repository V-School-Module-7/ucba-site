...
const LawsAndLicenses = () => {
    return (
        <Container id="laws-and-licenses">
            ...
            <Paragraph>Registration of beekeeper</Paragraph>
            <Paragraph>Appointment of a County Inspector</Paragraph>
            <Paragraph>Requirement of hives to have removable frames</Paragraph>
            <Paragraph>Duties of the appointed County Inspector</Paragraph>
            <Paragraph>
            ...
            <Paragraph>Queen raising specific information</Paragraph>
            <Paragraph>
            ...
            <Paragraph>Authorization for quarantine against infectious disease</Paragraph>
            <Paragraph>Unlawful acts are specified</Paragraph>
            <Paragraph>Maintenance of abandoned apiary equipment to prevent nuisance</Paragraph>
            <Paragraph>
                Wax salvage operations and county inspector supervisor 
                for compliance
            </Paragraph>
            <Paragraph>Utah Rule 68-1- this is the rule that is known as the bee inspection act.</Paragraph>
            <Paragraph>It governs the following key items:</Paragraph>
            <Paragraph>Reinforcement of the need for registration as specified in title 4.</Paragraph>
            <Paragraph>
            ...
            <Paragraph>Assistance to County Inspector in locating hives.</Paragraph>
            <Paragraph>
