    ...
    <HomeContainer>
      ...
      <AnswerContainer>
        <AnswerQuestion>
          ...
          <TextHeader4>How high up is the swarm?</TextHeader4>
          <TextHeader4>
            Are there any special concerns in the area? (lots of children, water
            hazards, bees in the house etc)
          </TextHeader4>
        </AnswerQuestion>
        <AnswerImg>
      ...
      <AnswerContainer>
        <AnswerQuestion>
          <TextHeader3>
            Here are some images of the kinds of "bees" that beekeepers do not
            remove:
          </TextHeader3>
        </AnswerQuestion>
        <AnswerImg>
      ...
      <AnswerContainer2>
        <AnswerQuestion>
          <Paragraph>
            ...
            where there is winter, they will not survive. A wasp nest (upper
